...
/**
 * Formats an `APIGatewayProxyResult` object to be returned from an asynchrnous Lambda handler.
 ...
 * @returns An `APIGatewayProxyResult` that can be returned immediately from a Lambda.
 */
 ...
 * automatically when it is called from the console or by API Gateway. The result should be
 * generated by the `response()` function in this module.
*/
 ...
 * @returns The same handler wrapped in a try/catch block, returned in an object formatted to be exported
 */
